...
// 1. SEO Metadata (Next.js 16 requires awaiting params)
export async function generateMetadata({ params }) {
  ...
  return {
    title: data.seo?.metaTitle || `${data.name} | MBBS Abroad 2026`,
  ...
  const commonFAQs = [
    {
      ...
      a: "Yes, recognized by NMC and WHO.",
    },
    {
      q: "Is NEET mandatory?",
      a: "Yes, qualifying NEET is mandatory for Indian students.",
    },
    {
      q: "Medium of instruction?",
      a: "The entire 6-year course is taught in English.",
    },
  ];
    ...
    <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-12">
          ...
          {/* {rich text editor} */}
          {/* Pehle check karo ki detailedContent exist karta hai ya nahi */}
          {data?.detailedContent && (
            <div className="mt-12 bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
              ...
              <div
                className="prose prose-blue lg:prose-xl max-w-none prose-headings:text-slate-900 prose-p:text-slate-600 prose-li:text-slate-600"
                // Safe check: Agar data null hai toh empty string bhej do
