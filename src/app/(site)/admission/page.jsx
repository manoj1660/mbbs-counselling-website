...
import { CheckCircle, School, FileText, Send, UserCheck, Plane, MapPin, User, Mail, Phone, Globe, Building2, MessageSquare, ArrowRight } from 'lucide-react';

const AdmissionStep = ({ icon: Icon, title, description, stepNumber }) => (
  <div className="flex gap-6 items-start relative pb-12 last:pb-0">
    {stepNumber < 7 && <div className="absolute left-6 top-10 w-0.5 h-full bg-blue-100" />}
      ...
      <section className="py-12 bg-white/60">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-12 items-center opacity-60">
            {/* Yahan NMC/WHO approved logos ka badal sakte ho */}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid lg:grid-cols-[1fr,400px] gap-12">
        ...
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100">
          ...
          <section className="mb-20">
            ...
            <div className="prose prose-lg text-gray-700 max-w-none">
              <ul className="space-y-4">
                ...
                <li><strong>Academic Performance:</strong> A minimum of 50% aggregate marks in Physics, Chemistry, and Biology (PCB) for General candidates, and 40% for Reserved candidates (OBC/SC/ST).</li>
                <li><strong>NEET-UG:</strong> Must have qualified the NEET-UG exam within the last 3 years, as per NMC guidelines.</li>
                <li><strong>Passport:</strong> Must have a valid passport (valid for at least 18 months).</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="mt-10">
              <FAQItem question="Is an MBBS degree from abroad valid in India?" answer="Yes, provided you complete your MBBS from an NMC-approved university and qualify for the NEXT/FMGE exam in India after returning." />
              <FAQItem question="What is the medium of instruction?" answer="Most NMC-approved universities abroad offer the entire MBBS course in English medium. We specialize in such universities." />
              <FAQItem question="Do I need to qualify NEET?" answer="Yes, qualifying NEET is mandatory for all Indian students aspiring to study MBBS abroad and wishing to practice medicine in India." />
              <FAQItem question="What is the estimated budget?" answer="The complete 6-year course including hostel and food generally ranges from INR 15 Lakhs to 35 Lakhs, depending on the country and university." />
            </div>
          </section>
        </div>
        ...
        <div className="lg:sticky lg:top-8 h-fit">
          <div className="bg-white p-8 rounded-3xl shadow-xl border-t-4 border-blue-600">
            ...
            <p className="text-gray-600 mb-8">Limited seats available for the 2026 Intake. Fill the form, and our expert will call you back within 24 hours.</p>
